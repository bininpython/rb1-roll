...
function renderRb1Completa() {
  ...
  // 1. Top 1
  svg += dot(7066, YM - 15, 15);
  // 2. Bottom 1
  svg += dot(7132, YM + 15, 15);
  // 3. Top 2
  svg += dot(7198, YM - 15, 15);
  // 4. Bottom 2
  svg += dot(7264, YM + 15, 15);
  ...
  // 6. Bottom 3
  svg += dot(7396, YM + 15, 15);
  // 7. Top 3
  svg += dot(7462, YM - 15, 15);
  // 8. Bottom 4
  svg += dot(7528, YM + 15, 15);
  // 9. Top 4
  svg += dot(7594, YM - 15, 15);
